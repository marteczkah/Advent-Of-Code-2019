...
public class DayFivePart2 {
        ...
        //part 2
        public static void computerTwo(int[] values){
            ...
            while (i < size){
                ...
                if (instruct[0]==1){
                ...
                else if (instruct[0]==5){
                    if (instruct[1]==0 && instruct[2]==0){//5
                    ...
                    else if (instruct[1]== 1 && instruct[2]== 1){//1105
                        if (values[i+1]!=0){
                            i=values[i+2];
                        }
                        else {
                    ...
                    else if (instruct[1]== 1 && instruct[2]== 0){//105
                        if (values[i+1]!=0){
                            i=values[values[i+2]];
                        }
                        else {
                    ...
                    else if (instruct[1]== 0 && instruct[2]== 1){//1005
                        if (values[values[i+1]]!=0){
                            i=values[i+2];
                        }
                        else {
                ...
                else if (instruct[0]==6){
                    if (instruct[1]==0 && instruct[2]==0){
                        if (values[values[i+1]]==0){
                            i=values[values[i+2]];
                        }
                        else {
                    ...
                    else if (instruct[1]==1 && instruct[2]==1){
                        if (values[i+1]==0){
                            i=values[i+2];
                        }
                        else {
                    ...
                    else if (instruct[1]==1 && instruct[2]==0){
                        if (values[i+1]==0){
                            i=values[values[i+2]];
                        }
                        else {
                    ...
                    else if (instruct[1]==0 && instruct[2]==1){
                        if (values[values[i+1]]==0){
                            i=values[i+2];
                        }
                        else {
                ...
                else if (instruct[0] == 7){
                    if (instruct[1]==0 && instruct[2]==0 && instruct[3]==0){//7
                    ...
                    else if (instruct[1]==1 && instruct[2]==1 && instruct[3]==0){//1107
                    ...
                    else if (instruct[1]==1 && instruct[2]==0 && instruct[3]==0){//107
                        if (values[i+1]<values[values[i+2]]){
                            values[values[i+3]]=1;
                        }
                        else {
                            values[values[i+3]]=0;
                    ...
                    else if (instruct[1]==0 && instruct[2]==1 && instruct[3]==0){//1007
                        if (values[values[i+1]]<values[i+2]){
                            values[values[i+3]]=1;
                        }
                        else {
                            values[values[i+3]]=0;
                ...
                else if (instruct[0] == 8){
                    if (instruct[1]==0 && instruct[2]==0 && instruct[3]==0) {
                        if (values[values[i+1]]==values[values[i+2]]){
                            values[values[i+3]]=1;
                        }
                        else {
                    ...
                    else if (instruct[1]==1 && instruct[2]==1 && instruct[3]==0){
                        if (values[i+1]==values[i+2]){
                            values[values[i+3]]=1;
                        }
                        else {
